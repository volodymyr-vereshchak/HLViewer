...
def main(page: ft.Page):
    ...
    main_tab = ft.Tabs(
        tabs=[
            ft.Tab(text="Settings", content=tab_content, icon=ft.Image(src="D:/Projects/HLViewer/HLViewer/frontend/src/assets/settings-svgrepo-com.svg", width=32, height=32,)),
