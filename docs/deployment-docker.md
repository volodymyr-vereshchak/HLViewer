...
# AUTO_LOGIN=true — автоматичний вхід як DEFAULT_USERNAME без вікна логіну (зручно для
# внутрішнього стенду). Для боєвого середовища з розмежуванням прав ставте false.
AUTO_LOGIN=true
