...
class EditEngine(Hostlib):
    ...
    async def read(self):
        ...
        edit_type_dao = EditTypeDao(session=self.session)
        ...
        for file in files:
            ...
            edit_list = await edit_type_dao.get_by_gas_volume_type_id(
                ...
                try:
                    ...
                    if file_dict.get("edit_type_id") is not None:
                        try:
                            ...
                            new_item = await edit_type_dao.create_item(new_edit)
